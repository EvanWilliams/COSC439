...
void CreateTCPConnection(){
	...
	extern char *servIP;                    /* Server IP address (dotted quad) */
	extern int sock;
...
void RecieveLoop(){
	extern int bytesRcvd, totalBytesRcvd;   /* Bytes read in single recv()*/
	extern unsigned int echoStringLen;      /* Length of string to echo */
